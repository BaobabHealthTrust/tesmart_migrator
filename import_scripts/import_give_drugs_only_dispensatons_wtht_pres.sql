...
DROP PROCEDURE IF EXISTS `proc_import_give_drugs_disp_wtht_pres`$$

# Procedure does not take any parameters. It assumes fixed table names and database
# names as working with flexible names is not supported as of writing in MySQL.
CREATE PROCEDURE `proc_import_give_drugs_disp_wtht_pres`(
...
`bart1_intermediate_bare_bones`.`give_drugs_encounters` 
       ...
       AND (`bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name1` IS NULL
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name2` IS NULL
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name3` IS NULL
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name4` IS NULL
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name5` IS NULL)
      OR (`bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name1` <>  `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name1`
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name1` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name2` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name1` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name3` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name1` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name4` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name1` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name5`)
       OR (`bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name2` <>  `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name1`
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name2` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name2` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name2` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name3` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name2` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name4` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name2` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name5` )
       OR (`bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name3` <>  `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name1`
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name3` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name2` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name3` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name3` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name3` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name4` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name3` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name5` )
       OR (`bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name4` <>  `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name1`
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name4` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name2` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name4` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name3` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name4` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name4` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name4` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name5` )
       OR (`bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name5` <>  `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name1`
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name5` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name2` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name5` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name3` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name5` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name4` 
       AND `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`dispensed_drug_name5` <> `bart1_intermediate_bare_bones`.`give_drugs_encounters`.`pres_drug_name5` );
...
#----------------------------------------------------------------------------------------------------------------------------
        ...
        IF NOT ISNULL(dispensed_drug_name2) THEN
           ...
           ELSE
            ...
            #create dispensing encounter
            SET @dispensing_encounter_with_old_enc_id = COALESCE((SELECT encounter_id FROM temp_encounter WHERE encounter_id = @dispensing_without_pres_encounter_id AND encounter_type = 54), 0);
...
#----------------------------------------------------------------------------------------------------------------------------
        ...
        IF NOT ISNULL(dispensed_drug_name5) THEN
           ...
           ELSE
            ...
            #create dispensing encounter
            SET @dispensing_encounter_with_old_enc_id = COALESCE((SELECT encounter_id FROM encounter
                                WHERE encounter_id = @dispensing_without_pres_encounter_id
                                AND encounter_type = 54), 0);
