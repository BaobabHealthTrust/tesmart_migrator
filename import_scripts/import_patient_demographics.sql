...
DROP PROCEDURE IF EXISTS `proc_import_patient_demographics`$$

# Procedure does not take any parameters. It assumes fixed table names and database
# names as working with flexible names is not supported as of writing in MySQL.
CREATE PROCEDURE `proc_import_patient_demographics`(
  #--IN start_pos INT(11),
  #--IN end_pos INT(11)
...
BEGIN
    ...
    read_loop: LOOP
        ...
        VALUES (SUBSTRING(gender, 1, 1), dob, @date_of_birth_estimated, @patient_dead, @creator, date_created, (SELECT UUID()));
        ...
        IF COALESCE(current_address, "") != "" THEN
            ...
            VALUES (@person_id, current_address, @creator, date_created, @person_address_uuid);
          ...
          IF COALESCE(landmark, "") != "" THEN
            ...
            INSERT INTO person_attribute (person_id, value, person_attribute_type_id, creator, date_created, uuid)
            VALUES (@person_id, landmark, @landmark_type_id, @creator, date_created, @person_address_uuid);
