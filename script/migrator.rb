...
def start
  patients = TesmartPatient.find(:all, :conditions => ["patientid >= ?", 4333])
...
def create_patient(t_patient)
  ...
  new_patient.date_created = t_patient.cdate.blank? ? t_patient.mdate : t_patient.cdate 
...
def create_guardian(t_patient, patient_id)
  ...
  new_guardian.date_created = t_patient.cdate.blank? ? t_patient.mdate : t_patient.cdate
  new_guardian.save
...
def create_first_visit_encounter(t_patient, patient_id)
  ...
  new_first_visit_enc.date_created = t_patient.cdate.blank? ? t_patient.mdate : t_patient.cdate
